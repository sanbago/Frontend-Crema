...
type Props = {
  ...
  selectedContact: DoctorObjType | null;
  onShowDetail: (show: boolean) => void;
  onChangeStarred: (status: boolean, contact: DoctorObjType) => void;
  onSelectContactsForDelete: (ids: number[]) => void;
  onOpenEditContact: (contact: DoctorObjType) => void;
};
...
const ContactDetail = (props: Props) => {
  ...
  const [contact, setContact] = useState<DoctorObjType | null>(
    selectedContact
  );
